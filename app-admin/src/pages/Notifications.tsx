...
interface Notification {
  id: string;
  type: 'account_request' | 'system' | 'analytics' | 'dashboard' | 'settings';
  title: string;
  message: string;
  timestamp: Date;
  read: boolean;
...
const mockNotifications: Notification[] = [
  {
    ...
    message: 'Acme Corp has requested an Enterprise account',
  ...
  },
  {
    ...
    message: 'Dashboard views increased by 45% in the last hour',
  ...
  },
  {
    id: '4',
    type: 'dashboard',
    title: 'New Dashboard Published',
    message: 'TechCorp published "Q4 Sales Analytics" dashboard',
  ...
  },
  {
    ...
    message: 'StartupXYZ Enterprise account has been activated',
